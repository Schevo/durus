"""
$URL: svn+ssh://svn.mems-exchange.org/repos/trunk/durus/test/utest_file.py $
$Id: utest_file.py 29120 2006-12-05 23:10:57Z dbinger $
"""
...
class FileTest (UTest):
    ...
    def a(self):
        ...
        if os.name == 'nt':
            raises(pywintypes.error, h.write, 'b')
        else:
